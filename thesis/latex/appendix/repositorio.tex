...
Sección~\ref{sec:fuentes_datos} (\citealp{Rahman2022}; BishopFox BadPods, Kubernetes Goat y repositorios
...
\texttt{risk\_score} & Nodo (Capa~2) & — & Puntuación de severidad por manifiesto \(\in [0,1]\): heurística determinista en el corpus, probabilidad del Random Forest en inferencia (L10) \\
\bottomrule
\end{tabular}
\fuentepropia
\end{table}
