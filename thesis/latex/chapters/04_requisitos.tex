...
tolerancia al desequilibrio de clases y la calidad de las probabilidades que
produce, requisito este último derivado de que dicha salida se emplea como
...
ni muestreo aleatorio del espacio de configuraciones. El conjunto de test se
reserva en consecuencia de forma exclusiva para la medición final del criterio de
aceptación de RF-1.
...
satisfacen. Las cuatro se definen a continuación junto con la razón por la que
resultan preferibles a alternativas de uso más extendido.
...
completo. En lugar de evaluar la clasificación por umbral, P@k mide la fracción de clústeres de cadena de ataque en las primeras
