...
\begin{description}
  \item[RF-1 — Detección de configuraciones erróneas individuales.] El sistema debe cumplir
    ...
    nomenclatura del modelo—. La segunda es producir un
    ...
    (Checkov, kube-linter) ya cubren esta capacidad a nivel de
...
\begin{description}
  ...
  \item[RNF-2 — Reproducibilidad.] Los modelos entrenados deben almacenarse como
    ...
    entrega si falla—, donde el mismo manifiesto debe
