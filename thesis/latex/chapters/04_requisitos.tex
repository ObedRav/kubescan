...
\begin{description}
  ...
  \item[RF-5 — Priorización de riesgos.] El sistema debe producir una clasificación
    ...
    0,70 (umbral adoptado de OE4, Capítulo~\ref{cap:objetivos}, aunque allí se
    define como media de validación cruzada de 5~pliegues de la Capa~2 y aquí
    se aplica al ranking del sistema desplegado sobre el conjunto de test), de
