...
el Capítulo~\ref{cap:diseno}: el clasificador binario y el modelo de severidad. Se
...
Sección~\ref{sec:requisitos}. Esta evaluación complementa las métricas de las
capas 1--3, que miden capacidad predictiva, con evidencia de que el sistema es
efectivamente utilizable como herramienta de línea de comandos. Los cuatro
requisitos no funcionales se verifican de forma independiente a continuación.
...
trabajos revisados en el Capítulo~\ref{cap:estado}. La comparación se organiza
por capa, dado que la Capa~1 dispone de referencias directas en la literatura de
clasificación de \textit{IaC}, mientras que la Capa~2 carece de trabajos previos
estrictamente comparables. En ambos casos se prioriza la comparación con
resultados obtenidos sobre conjuntos de datos de tamaño y naturaleza similares.
