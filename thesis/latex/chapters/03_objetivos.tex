...
\begin{description}
  ...
  \item[OE4.] Desarrollar una Capa~2 de clasificación de clústeres basada en \ac{GAT}
    ...
    en la detección de cadenas de ataque.

  \item[OE5.] Implementar una Capa~3 que optimice mediante Algoritmo Genético una
    función objetivo combinada de Precisión@5 y falsos positivos de clústeres limpios,
    garantizando \ac{FPR}\_clean\,=\,0 sobre el conjunto de validación y manteniendo
    una Precisión@5 competitiva con la del mejor componente individual.
  ...
  \item[OE6.] Empaquetar el sistema completo como una herramienta de línea de comandos
    ...
    \textit{kubectl}; instalable en entornos Python 3.10+ en menos de 60 segundos
    (\texttt{pip install}, caché de paquetes vacía, conexión de banda ancha).
\end{description}
...
de 28 características binarias por manifiesto mediante análisis estático
multi-herramienta (Sección~\ref{sec:features_table}) y construcción del grafo de
...
documentada en la Sección~\ref{sec:gnn_por_clase}.
