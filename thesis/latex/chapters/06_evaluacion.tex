...
continua que ordena los manifiestos por densidad de misconfiguraciones. No se
...
sobre el mismo protocolo. La literatura sobre \acs{GNN}s aplicadas a grafos
...
Figura~\ref{fig:ensemble_patk} resume las
...
test. En él, la matriz de confusión del ensemble
...
Como contraste externo, se ejecutó \textit{Checkov} \citep{Checkov2021} sobre el
...
precisamente la salida de \textit{Checkov} la que las rellena en tiempo de carga
...
métricas predictivas reportadas en las Secciones~\ref{sec:layer1},
\ref{sec:layer2}, \ref{sec:layer3} y~\ref{sec:metrica_global}, y las
comprobaciones operacionales realizadas sobre la herramienta de línea de comandos
...
contra las métricas ya reportadas, mientras que RF-3, RF-4 y los cuatro
