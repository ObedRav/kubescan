...
protocolo preliminar. El objetivo de diseño de ranking es P@5\,>\,0,70 y el umbral
...
Tabla~\ref{tab:ensemble_ablation} recoge las tres métricas de ranking del
...
el conjunto de test, ya reportado en la Sección~\ref{sec:layer3} y recogido en
