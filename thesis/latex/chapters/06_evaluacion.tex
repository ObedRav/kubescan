...
% [CONSULTA AL AUTOR 2] La frase suprimida al final de este parrafo decia: «La
% fase final group-aware no esta incluida en el grafico y se reporta en la
% Tabla~\ref{tab:gnn_evolution}». Remitia a una figura que ya no forma parte del
% documento (figures/fig_gnn_evolution.pdf existe pero no se incluye en ningun
% \includegraphics) y ademas contradecia la propia tabla, cuya ultima fila SI
% recoge la fase final. Si se desea restituir la figura, hay que reinsertarla y
% devolver la frase; si no, esta version es la correcta.
