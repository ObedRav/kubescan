...
Capítulo~\ref{cap:requisitos}. El capítulo cierra con la evaluación de
usabilidad y aplicabilidad realizada con usuarios expertos. Las métricas
empleadas se justifican en detalle en la Sección~\ref{sec:metricas}.
...
Esta sección verifica el cumplimiento de los requisitos funcionales y no
funcionales definidos en el Capítulo~\ref{cap:requisitos}, complementando las
métricas predictivas de las secciones anteriores con evidencia de que el
sistema es efectivamente utilizable como herramienta de línea de comandos.
...
se verifican mediante evidencia operacional obtenida sobre la implementación
