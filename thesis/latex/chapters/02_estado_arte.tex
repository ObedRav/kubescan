...
o evalúan según la encuesta anual de la \ac{CNCF}
...
\textit{misconfiguration} mediante su propia herramienta de análisis estático. De
...
de clases moderado (56,3\,\% seguros vs.\ 43,7\,\% \textit{misconfigured}); el
...
\citep{Malul2024}. Si bien los \ac{LLM}s ofrecen capacidades de razonamiento semántico
...
intrusiones en red, identificando tres paradigmas: detección
...
explícitas y auditables. Al operar sobre manifiestos \ac{YAML} sin requerir acceso
