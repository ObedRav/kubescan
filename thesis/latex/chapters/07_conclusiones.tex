...
variación. En la Capa~2 la imputación es a 0 y alcanza a las 1.906~filas de Rahman
et~al., pero no depende de la cobertura de escaneo, por lo que no compromete la
comparabilidad entre configuraciones. L10 acota en cambio la interpretación de la
arquitectura: la contribución de la Capa~1 a la Capa~2 no está medida, porque el
atributo nodal previsto para transmitirla está vacío en el 86\,\% de los grafos. L9 añade una restricción del mismo orden:
