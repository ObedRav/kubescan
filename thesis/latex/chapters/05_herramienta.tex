...
que aplican automáticamente ruff y mypy en cada commit. La suite de tests cubre
el parser de \acs{YAML} (\texttt{utils/yaml\_parser.py}), la construcción del
...
del sistema en el Capítulo~\ref{cap:evaluacion}.
