...
del clasificador \textit{Random Forest}; la Sección~\ref{sec:capa2_diseno} detalla
...
nodo de las 1.906~filas procedentes de Rahman et~al. Ese relleno no es un
...
\textit{Random Forest}. Está poblada únicamente para los 82~clústeres procedentes
