...
del grafo, codificador \ac{GAT}, clasificador \ac{RF}, ensamblador \ac{GA},
utilidades de dispositivo y un módulo de pruebas basadas en propiedades con
\textit{Hypothesis}— y un módulo de integración de extremo a extremo, cuya
verificación funcional se reporta como evidencia de RF-1 y RF-2 en la
...
centraliza las semillas de \texttt{random}, \textit{NumPy} y \textit{PyTorch};
...
\textit{skops} contra una lista blanca restringida a \textit{scikit-learn} y
\textit{NumPy}, de modo que un \textit{checkpoint} manipulado no pueda introducir
