...
\raggedright
  \item \textbf{18 banderas Rahman} (subconjunto del trabajo original): \texttt{TRUE\_HOST\_PID},
    ...
    etc.
  \item \textbf{3 features derivadas}: \texttt{cap\_misuse} (OR de las dos banderas de
...
\acs{YAML} disponible, sino específica de la fuente: Checkov se ejecutó únicamente sobre el subconjunto de
...
La Capa~2 (\ac{GNN}) consume únicamente las 18~banderas Rahman y las 7~features extendidas
...
con el conjunto de banderas de Rahman et~al.\ \citep{Rahman2022}; no se ha realizado
...
Checkov sobre el subconjunto de GitHub (1.175) e imputación por mediana de
...
El desarrollo de kubescan sigue prácticas de ingeniería de software
...
\textit{skops} contra una lista blanca restringida a scikit-learn y
