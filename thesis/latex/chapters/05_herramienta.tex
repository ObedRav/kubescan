...
Este capítulo describe de forma completa el sistema \textit{kubescan}, desde su
arquitectura general hasta los detalles de su implementación como herramienta de
software distribuible. Se presenta primero la arquitectura de tres capas, y a
continuación los procesos de construcción del conjunto de datos y del grafo de
clúster que alimentan dichas capas. Le siguen el diseño de entrenamiento de cada
capa, la interfaz de línea de comandos resultante y las prácticas de ingeniería
de software adoptadas durante el desarrollo. La implementación completa se
encuentra disponible en el repositorio indicado en el
Apéndice~\ref{ap:repositorio}.
...
tests unitarios y de integración del paquete; y (4) \textit{pre-commit hooks},
...
que estos tests de integración realizan se reporta como parte de la evaluación
del sistema en el Capítulo~\ref{cap:evaluacion}.\par}
