...
del clasificador \textit{Random Forest}; la Sección~\ref{sec:construccion_grafo}
...
\textit{Checkov} tampoco es un mecanismo general aplicable a toda fila con
\acs{YAML} disponible, sino específica de la fuente: \textit{Checkov} se ejecutó únicamente sobre el subconjunto de
