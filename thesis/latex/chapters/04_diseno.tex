...
la cobertura ascendió al 3,8\,\%. En cuanto a los conjuntos de datos de referencia
...
mismo orden de magnitud que el de este trabajo (56,3\,\% seguros vs.\ 43,7\,\%
...
El dataset de grafos final comprende 599~grafos originales (25~clean, 537~isolated,
...
el número de clústeres de cadena de ataque del corpus preliminar de 471~grafos
ascendió de 13 a 15 (37 en el corpus final de 599).\par}
...
y el 25\,\%, restringida a seis características de baja importancia — nunca las
flags de escape, \texttt{HOSTPATH\_MOUNT} ni el \textit{risk\_score}); y
\textit{subgraph sampling} (extracción de un subgrafo inducido por entre el 40\,\%
y el 70\,\% de nodos, aplicada solo a grafos de más de 50~nodos, con \textit{BFS}
...
tienen \(\geq\)2 nodos y \(\geq\)1 arista, mientras que 499 de los 537 grafos
