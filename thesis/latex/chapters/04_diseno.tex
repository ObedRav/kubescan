...
La Figura~\ref{fig:arquitectura} muestra el pipeline de tres capas, desde los
...
lateral y limpio) y las aristas dirigidas que cada uno origina. Como se observa,
el nodo rojo (pod-A) tiene
