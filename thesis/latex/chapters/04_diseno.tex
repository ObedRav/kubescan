...
propiedades de calidad. Ambos conjuntos se detallan a continuación.
...
del grafo de entrada de la Capa~2. Las secciones siguientes detallan, en este mismo
orden, la construcción del conjunto de datos, la construcción del grafo y el diseño
...
manifiesto en un vector estructurado. El conjunto resultante es la base tanto del
clasificador de la Capa~1 como del grafo de clúster construido en la
Sección~\ref{sec:construccion_grafo}.
...
(2.818/2.827 activa, sin poder discriminativo). Se conservan pese a su bajo aporte
individual porque su ausencia no simplifica el vector de nodo ni mejora el
entrenamiento de forma medible.
...
\midrule
Proximidad de directorio & 0 & Bidireccional & Mismo subdirectorio \acs{YAML} \\
...
{\raggedright
La suite de tests cubre los siguientes componentes: el parser de \acs{YAML}
