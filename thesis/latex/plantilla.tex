...
% --- Ajustes APA 7 sobre apacite -------------------------------------------
% apacite implementa APA 6 y, con el fichero de idioma español (spanish.apc),
% abrevia «et al.» como «y cols.». APA 7 en español mantiene «et al.», de modo
% que se restituye tras cargar el idioma.
\AtBeginDocument{%
  \renewcommand{\BOthers}[1]{et~al.\hbox{}}%
  \renewcommand{\BOthersPeriod}[1]{et~al.\hbox{}}%
}
% APA 7 sustituye el prefijo «doi:» por el DOI en forma de URL resoluble. apacite
% compone el prefijo como texto corriente y el identificador con \Url, en dos
% cajas distintas: eso deja el prefijo en otra fuente que las URL y permite un
% corte de línea entre ambos que inserta un espacio visible y rompe la cadena al
% copiarla. Se traslada el prefijo a \UrlLeft, dentro del propio \Url, para que
% todo el DOI sea una sola URL con la misma fuente y los cortes que url.sty
% gestiona. No puede hacerse con \url{https://doi.org/#1} porque hay DOI con
% guion bajo (10.1007/978-3-031-17140-6_29) que exigen la lectura de \Url.
\renewcommand{\doiprefix}{}
\AtBeginDocument{%
  \renewcommand{\doi}{\begingroup\urlstyle{tt}\def\UrlLeft{https://doi.org/}\Url}%
}
% amsmath, graphicx y hyperref ya los carga estilo_unir-1, que se lee antes.
\usepackage{bookmark}
\hypersetup{hidelinks}  % enlaces navegables sin recuadros de color (aspecto elegante)
\usepackage{booktabs}
\usepackage{multirow}
\usepackage{acronym}  % la lista se compone en appendix/acronimos.tex
\usepackage{tocloft}
...
% tocloft no crea un macro de título para las listas nuevas (a diferencia de
% \listfigurename/\listtablename), así que se declara aquí y se reutiliza tanto
% en la lista como en su entrada del índice de contenidos.
\newcommand{\listecuacionesname}{Índice de ecuaciones}
\newlistof{ecuaciones}{loe}{\listecuacionesname}
...
%\includeonly{chapters/06_evaluacion}

\begin{document}
% APA 7 abrevia con «et al.» desde la primera cita en los trabajos de tres o más
% autores, a diferencia de APA 6 —que apacite implementa— y que desglosaba todos
% los autores la primera vez. \shortcites fuerza la forma breve en esos trabajos.
\shortcites{Velickovic2018,Hamilton2017,Xu2019,Zhou2020,Pedregosa2011,Rahman2022,%
Malul2024,Bilot2023,Lo2022,Li2022,Hagberg2008,Paszke2019,Jabeen2022,Hutchins2011,%
GNNSurvey2024,Lin2017,Bangor2009}
...
\tableofcontents
% Los tres índices auxiliares se listan en el índice de contenidos, igual que
% las referencias bibliográficas; \phantomsection fija el destino del enlace.
\clearpage
\phantomsection
...
\clearpage
\phantomsection
\addcontentsline{toc}{chapter}{\listecuacionesname}
\listofecuaciones
\clearpage
...
\startchapter\include{chapters/04_requisitos}
\startchapter\include{chapters/05_herramienta}
\startchapter\include{chapters/06_evaluacion}
\startchapter\include{chapters/07_conclusiones}
